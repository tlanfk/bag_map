...
namespace bag_map
{
    public partial class Form1 : Form
    {
        ...
        private void AddSensitivityControls()
        {
            ...
            sidePanel.Controls.Add(new Label { Font = new Font("맑은 고딕", 9), ForeColor = Color.Gray, AutoSize = true, Location = new Point(158, startY + 43), Name = "zoom_value_label" });
            sidePanel.Controls.Add(new Label { Font = new Font("맑은 고딕", 9), ForeColor = Color.Gray, AutoSize = true, Location = new Point(158, startY + 113), Name = "pan_value_label" });
